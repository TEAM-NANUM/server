...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    List<Order> findByUserAndReview_IdIsNullAndDeliveryStatusOrderByCreateAtDesc(@Param("user") User user, @Param("delivery") DeliveryStatus delivery);
    ...
    List<Order> findByUserAndReview_IdIsNotNullAndDeliveryStatusOrderByCreateAtDesc(@Param("user") User user, @Param("delivery") DeliveryStatus delivery);
